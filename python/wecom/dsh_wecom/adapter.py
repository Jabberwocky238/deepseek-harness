...
from .helpers import MessageDeduplicator, env_float, get_secret as _get_scoped_secret
...
class WeComAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = env_float("DSH_WECOM_TEXT_BATCH_DELAY_SECONDS", 0.6)
        self._text_batch_split_delay_seconds = env_float("DSH_WECOM_TEXT_BATCH_SPLIT_DELAY_SECONDS", 2.0)
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            from .net import platform_httpx_limits, ssrf_redirect_guard
            from .url_safety import create_ssrf_safe_async_client
    ...
    async def _download_remote_bytes(
        ...
        from .net import ssrf_redirect_guard
        from .url_safety import create_ssrf_safe_async_client, is_safe_url
...
_QR_CODE_PAGE = "https://work.weixin.qq.com/ai/qc/gen?source=dsh&scode="
...
def qr_scan_for_bot_info(
    *,
    ...
    generate_url = f"{_QR_GENERATE_URL}?source=dsh"
